...
set_property PACKAGE_PIN U18 [get_ports bp_tri_i[0]]
	set_property IOSTANDARD LVCMOS33 [get_ports bp_tri_i[0]]
set_property PACKAGE_PIN T18 [get_ports bp_tri_i[1]]
	set_property IOSTANDARD LVCMOS33 [get_ports bp_tri_i[1]]
set_property PACKAGE_PIN W19 [get_ports bp_tri_i[2]]
	set_property IOSTANDARD LVCMOS33 [get_ports bp_tri_i[2]]
set_property PACKAGE_PIN T17 [get_ports bp_tri_i[3]]
	set_property IOSTANDARD LVCMOS33 [get_ports bp_tri_i[3]]
set_property PACKAGE_PIN U17 [get_ports bp_tri_i[4]]
	set_property IOSTANDARD LVCMOS33 [get_ports bp_tri_i[4]]
