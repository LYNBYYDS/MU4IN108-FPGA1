...
namespace eval ::optrace {
  variable script "/users/enseig/li/Bureau/FPGA/TP1/project_2/project_2.runs/impl_1/Top.tcl"
...
OPTRACE "add files" START { }
  add_files -quiet /users/enseig/li/Bureau/FPGA/TP1/project_2/project_2.runs/synth_1/Top.dcp
