...
HD_PWD='C:/Users/marcs/OneDrive/Bureau/Desktop/FPGA/Project_FPGA_IP/Project_FPGA_IP.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Project_FPGA_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Project_FPGA_wrapper.tcl -notrace
