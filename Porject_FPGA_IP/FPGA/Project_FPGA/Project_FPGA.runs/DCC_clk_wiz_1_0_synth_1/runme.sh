...
HD_PWD='C:/Users/marcs/OneDrive/Bureau/Desktop/FPGA/Project_FPGA/Project_FPGA.runs/DCC_clk_wiz_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DCC_clk_wiz_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DCC_clk_wiz_1_0.tcl
