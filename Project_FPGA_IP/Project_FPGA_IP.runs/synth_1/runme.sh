...
HD_PWD='C:/Users/marcs/OneDrive/Bureau/Desktop/FPGA/Project_FPGA_IP/Project_FPGA_IP.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Project_FPGA_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Project_FPGA_wrapper.tcl
