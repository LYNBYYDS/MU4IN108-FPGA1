...
HD_PWD='C:/Users/UserTP/Desktop/FPGA-main/TP3/TP3.runs/TP3_dlmb_bram_if_cntlr_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TP3_dlmb_bram_if_cntlr_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TP3_dlmb_bram_if_cntlr_0.tcl
