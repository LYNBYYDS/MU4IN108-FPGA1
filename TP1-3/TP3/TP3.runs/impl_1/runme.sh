...
HD_PWD='C:/Users/UserTP/Desktop/FPGA-main/TP3/TP3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TP3_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TP3_wrapper.tcl -notrace
