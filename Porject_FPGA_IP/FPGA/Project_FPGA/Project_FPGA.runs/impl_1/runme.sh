...
HD_PWD='C:/Users/marcs/OneDrive/Bureau/Desktop/FPGA/Project_FPGA/Project_FPGA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DCC_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DCC_wrapper.tcl -notrace
