...
#
# Generated by export_simulation on Wed May 10 12:31:02 +0200 2023
#
################################################################################
...
'-reset_run' switch to the './DCC.sh' script.
...
./DCC.sh -noclean_files

For more information on the script, please type './DCC.sh -help'.
